...
export default function ReviewUpdateTrip() {
  ...
  const handleContinueToBuild = () => {
    router.push("/update-trip/updating-trip");
  };
  return (
    <View
      style={{
    ...
    >
      ...
      <View style={{ marginTop: 20 }}>
        <Text style={{ fontSize: 18, color: Colors.gray }}>
          Please verify your details before updating your trip.
        </Text>
      </View>
      ...
      <TouchableOpacity style={styles.button} onPress={handleContinueToBuild}>
        <Text style={styles.buttonText}>Continue to Update</Text>
      </TouchableOpacity>
    </View>
  );
}
